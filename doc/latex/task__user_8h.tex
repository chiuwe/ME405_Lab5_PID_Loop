...
\begin{DoxyCompactList}\small\item\em \-This task reads measurements that were taken by the data acquisition task in task\-\_\-daq.$\ast$ and puts those measurements into a queue. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{\-Defines}
\begin{DoxyCompactItemize}
\item 
